...
$3`
        ...
        return (
          ...
          (t.prototype.doValidation = function (r, i, e, n) {
            ...
            var s = [],
              ...
              l = function (h) {
                var g = (e == null ? void 0 : e.trailingCommas)
                    ? tt(e.trailingCommas)
                    : Z.Error,
                  m = (e == null ? void 0 : e.comments)
                    ? tt(e.comments)
                    : a.commentSeverity,
                  p = (e == null ? void 0 : e.schemaValidation)
                    ? tt(e.schemaValidation)
                    : Z.Warning,
                  d = (e == null ? void 0 : e.schemaRequest)
                    ? tt(e.schemaRequest)
                    : Z.Warning;
                if (h) {
    ...
    function Vn(t) {
      try {
        return ye.parse(t).with({ fragment: null, query: null }).toString();
      } catch {
        return t;
      }
    }
