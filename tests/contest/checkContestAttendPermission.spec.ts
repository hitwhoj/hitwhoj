  ...
  describe("ACM", () => {
    describe("Running", () => {
      ...
      it("Root 不可以在比赛中报名担任 attendee 的公开比赛", () =>
        rejects(check(root, contestRunningACMAttendeesPub)));
      it("Root 不可以在比赛中报名担任 attendee 的私有比赛", () =>
        rejects(check(root, contestRunningACMAttendeesPrv)));
      ...
      it("Admin 不可以在比赛中报名担任 attendee 的公开比赛", () =>
        rejects(check(admin, contestRunningACMAttendeesPub)));
      it("Admin 不可以在比赛中报名担任 attendee 的私有比赛", () =>
        rejects(check(admin, contestRunningACMAttendeesPrv)));
    ...
    describe("Not Started", () => {
      ...
      it("User 可以在比赛开始前报名其他的私有比赛", () =>
        resolves(check(user, contestNotStartedACMGuestsPrv)));
