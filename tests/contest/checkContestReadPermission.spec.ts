  ...
  describe("ACM", () => {
    describe("Running", () => {
      ...
      it("User 可以在比赛中读取其他的公开比赛", () =>
        resolves(check(user, contestRunningACMGuestsPub)));
    ...
    describe("Not Started", () => {
      ...
      it("User 可以在比赛开始前读取担任 attendee 的公开比赛", () =>
        resolves(check(user, contestNotStartedACMAttendeesPub)));
      it("User 可以在比赛开始前读取担任 attendee 的私有比赛", () =>
        resolves(check(user, contestNotStartedACMAttendeesPrv)));
      it("User 可以在比赛开始前读取其他的公开比赛", () =>
        resolves(check(user, contestNotStartedACMGuestsPub)));
      ...
      it("Banned 可以在比赛开始前读取担任 attendee 的公开比赛", () =>
        resolves(check(banned, contestNotStartedACMAttendeesPub)));
      it("Banned 可以在比赛开始前读取担任 attendee 的私有比赛", () =>
        resolves(check(banned, contestNotStartedACMAttendeesPrv)));
      it("Banned 可以在比赛开始前读取其他的公开比赛", () =>
        resolves(check(banned, contestNotStartedACMGuestsPub)));
      it("Banned 不可以在比赛开始前读取其他的私有比赛", () =>
        rejects(check(banned, contestNotStartedACMGuestsPrv)));

      it("Guest 可以在比赛开始前读取其他的公开比赛", () =>
        resolves(check(guest, contestNotStartedACMGuestsPub)));
