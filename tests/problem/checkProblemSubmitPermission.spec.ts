...
describe("checkProblemSubmitPermission", () => {
  ...
  it("Root 可以提交不属于任何团队的公开题目", () =>
    resolves(check(root, problemPub)));
  it("Root 可以提交不属于任何团队的私有题目", () =>
    resolves(check(root, problemPrv)));
  it("Root 可以提交担任 Owner 身份的团队的公开题目", () =>
    resolves(check(root, problemTeamAPub)));
  it("Root 可以提交担任 Owner 身份的团队的私有题目", () =>
    resolves(check(root, problemTeamAPrv)));
  it("Root 可以提交担任 Admin 身份的团队的公开题目", () =>
    resolves(check(root, problemTeamBPub)));
  it("Root 可以提交担任 Admin 身份的团队的私有题目", () =>
    resolves(check(root, problemTeamBPrv)));
  it("Root 可以提交担任 Member 身份的团队的公开题目", () =>
    resolves(check(root, problemTeamCPub)));
  it("Root 可以提交担任 Member 身份的团队的私有题目", () =>
  ...
  it("Admin 可以提交不属于任何团队的公开题目", () =>
    resolves(check(admin, problemPub)));
  it("Admin 可以提交不属于任何团队的私有题目", () =>
    resolves(check(admin, problemPrv)));
  it("Admin 可以提交担任 Owner 身份的团队的公开题目", () =>
    resolves(check(admin, problemTeamAPub)));
  it("Admin 可以提交担任 Owner 身份的团队的私有题目", () =>
    resolves(check(admin, problemTeamAPrv)));
  it("Admin 可以提交担任 Admin 身份的团队的公开题目", () =>
    resolves(check(admin, problemTeamBPub)));
  it("Admin 可以提交担任 Admin 身份的团队的私有题目", () =>
    resolves(check(admin, problemTeamBPrv)));
  it("Admin 可以提交担任 Member 身份的团队的公开题目", () =>
    resolves(check(admin, problemTeamCPub)));
  it("Admin 可以提交担任 Member 身份的团队的私有题目", () =>
  ...
  it("Guest 不可以提交不属于任何团队的公开题目", () =>
    rejects(check(guest, problemPub)));
  it("Guest 不可以提交不属于任何团队的私有题目", () =>
